...
export function AddResourceDialog({ open, onClose, onSelect }: AddResourceDialogProps) {
  const [selectedResourceType, setSelectedResourceType] = useState<string | null>(null);

  const handleResourceSelect = (resourceType: string) => {
    setSelectedResourceType(resourceType);
    // We don't close the main dialog or call onSelect yet,
    // as we now open a form dialog for the selected resource type
  };
