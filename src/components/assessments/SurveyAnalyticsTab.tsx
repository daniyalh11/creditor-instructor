...
export const SurveyAnalyticsTab = ({ survey }: SurveyAnalyticsTabProps) => {
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">80% completion rate indicates strong student engagement with the survey.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Most students rated the course content as 'Excellent' or 'Good'.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Average response time of 8.5 minutes shows appropriate survey length.</p>
              </div>
            </div>
          </div>
        </CardContent>
