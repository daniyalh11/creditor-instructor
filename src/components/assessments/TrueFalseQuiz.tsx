...
const TrueFalseQuiz = () => {
  ...
  const timeLimitMinutes = 10; // This would be set during assessment creation
  ...
  const questions: Question[] = [
    ...
    {
      id: 3,
      statement: "There are 8 planets in our solar system.",
      correctAnswer: true
    }
  ];
          ...
          <Card className="text-center p-8">
            <CardContent>
              ...
              <div className="space-y-4 mb-6">
                <p className="text-lg">Your Score: <span className="font-bold text-blue-600">{score.correct}/{score.total} ({score.percentage}%)</span></p>
                {completionTime && (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">True/False Quiz</h1>
        ...
        <Card className="mb-6">
          <CardContent className="p-8">
            <h2 className="text-xl font-semibold mb-6">{currentQuestion.statement}</h2>
            ...
            >
              <div className="flex items-center space-x-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                ...
                <Label htmlFor="true" className="text-base cursor-pointer flex-1">
                  True
                </Label>
              </div>
              <div className="flex items-center space-x-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                <RadioGroupItem value="false" id="false" />
                <Label htmlFor="false" className="text-base cursor-pointer flex-1">
                  False
                </Label>
              </div>
            </RadioGroup>
