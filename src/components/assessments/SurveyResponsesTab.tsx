...
const sampleResponses = [
  {
    ...
    responses: {
      'q1': { question: 'How would you rate the course content?', answer: 'Excellent', type: 'mcq' },
      'q2': { question: 'What did you like most about this module?', answer: 'The practical examples and clear explanations helped me understand the concepts better.', type: 'descriptive' },
      'q3': { question: 'Was the pace of the course appropriate?', answer: 'Yes', type: 'mcq' },
      'q4': { question: 'Any suggestions for improvement?', answer: 'Maybe add more interactive exercises and real-world case studies.', type: 'descriptive' }
    }
  },
  {
    id: '2',
    ...
    responses: {
      'q1': { question: 'How would you rate the course content?', answer: 'Good', type: 'mcq' },
      'q2': { question: 'What did you like most about this module?', answer: 'The structured approach and step-by-step guidance.', type: 'descriptive' },
      'q3': { question: 'Was the pace of the course appropriate?', answer: 'Too fast', type: 'mcq' },
      'q4': { question: 'Any suggestions for improvement?', answer: 'Slow down the pace and provide more practice opportunities.', type: 'descriptive' }
    }
  }
];

export const SurveyResponsesTab = ({ survey }: SurveyResponsesTabProps) => {
          ...
          {selectedResponse && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {Object.entries(selectedResponse.responses).map(([key, response]: [string, any]) => (
