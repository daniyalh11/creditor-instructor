...
import { FileText, Link, Save, X, Upload, FileUp } from 'lucide-react';

interface SubmissionBlockEditModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (submissionData: any) => void;
  initialData?: any;
}

export const SubmissionBlockEditModal = ({ 
  isOpen, 
  onClose, 
  onSave, 
  initialData 
}: SubmissionBlockEditModalProps) => {
