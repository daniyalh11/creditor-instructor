...
interface QuizSubmissionStatusTabProps {
  quiz: any;
}
...
export const QuizSubmissionStatusTab = ({ quiz }: QuizSubmissionStatusTabProps) => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">Track student progress and submission status</p>
        </div>
      </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {student.status === 'pending' && student.startedAt && (
                      <p className="text-xs text-gray-500">
                        Started: {new Date(student.startedAt).toLocaleString()}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  {student.status === 'completed' && student.timeSpent && (
                    <div className="text-center">
                      <p className="text-lg font-semibold text-gray-700">{student.timeSpent}</p>
