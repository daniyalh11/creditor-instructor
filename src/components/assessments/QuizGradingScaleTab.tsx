...
interface QuizGradingScaleTabProps {
  quiz: any;
  onUpdate: (quiz: any) => void;
}
...
export const QuizGradingScaleTab = ({ quiz, onUpdate }: QuizGradingScaleTabProps) => {
  ...
  const updateGradeEntry = (index: number, field: string, value: any) => {
