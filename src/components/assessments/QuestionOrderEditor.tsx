...
import { MoreHorizontal, GripVertical, Edit, Trash2, Copy } from 'lucide-react';
...
interface QuestionOrderEditorProps {
  questions: Question[];
  onAddQuestion: () => void;
  onUpdateQuestion: (questionId: number, newTitle: string) => void;
...
export const QuestionOrderEditor = ({ 
  questions, 
  onAddQuestion, 
  onUpdateQuestion, 
  onDeleteQuestion,
  ...
  const handleDragStart = (e: React.DragEvent<HTMLDivElement>, questionId: number) => {
