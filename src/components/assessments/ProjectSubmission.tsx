...
import { ArrowLeft, Clock, Calendar, Users, FileText, CheckCircle, Circle, Upload } from 'lucide-react';
...
const ProjectSubmission = () => {
  ...
  const projectDetails = {
    ...
    description: "Build a complete web application with authentication, database integration, and responsive design",
    duration: "4 weeks",
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="text-center p-8">
            <CardContent>
              ...
              <p className="text-lg mb-4">Your project deliverable has been successfully submitted</p>
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-sm text-gray-600">{completedTasks}/{projectTasks.length} Completed</span>
                </div>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Live Demo URL (if available)</label>
                    <Input
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                This is a demonstration of project-based assessment. In a real scenario, 
                students would have weeks to complete their projects with regular check-ins 
