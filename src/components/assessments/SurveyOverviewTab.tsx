...
export const SurveyOverviewTab = ({ survey, onUpdate }: SurveyOverviewTabProps) => {
  ...
  const handleDelete = () => {
    if (confirm('Are you sure you want to delete this survey? This action cannot be undone.')) {
      ...
      // In a real app, this would navigate back or handle deletion
    }
  };
        ...
        <div className="flex gap-2">
          {!isEditing ? (
            <>
              ...
              <Button onClick={handleDelete} variant="outline" size="sm" className="text-red-600 hover:text-red-700 border-red-200 hover:border-red-300">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setEditData({ ...editData, timeLimit: parseInt(e.target.value) || 0 })}
                  placeholder="15"
                  min="1"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{survey.totalResponses}/{survey.totalStudents}</p>
                  </div>
                </div>
            ...
            <ol className="space-y-3">
              {currentInstructions.map((instruction: string, index: number) => (
                <li key={index} className="flex items-start gap-3">
                  <span className="text-sm font-medium text-orange-600 min-w-[20px]">{index + 1}.</span>
