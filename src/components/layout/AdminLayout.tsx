...
export const AdminLayout = ({ title = 'Dashboard' }: AdminLayoutProps) => {
  ...
  useEffect(() => {
    ...
    if (pathSegments.length > 0) {
      ...
      if (firstSegment === 'dashboard' || firstSegment === '') {
        ...
        newTitle = firstSegment.charAt(0).toUpperCase() + firstSegment.slice(1);
      } else if (firstSegment === 'courses' && pathSegments[1] === 'view' && courseId) {
