...
export const TabsEditor = ({ isOpen, onClose, onSave, initialData }: TabsEditorProps) => {
  ...
  const updateTab = (index: number, field: keyof TabContent, value: string) => {
  ...
  const triggerImageUpload = (tabIndex: number) => {
  ...
  const handleImageUpload = (tabIndex: number, event: React.ChangeEvent<HTMLInputElement>) => {
