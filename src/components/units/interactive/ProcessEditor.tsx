...
export const ProcessEditor = ({ isOpen, onClose, onSave, initialData }: ProcessEditorProps) => {
  const [steps, setSteps] = useState<ProcessStep[]>(initialData?.steps || [
    {
      title: 'Introduction',
