...
export const FlashcardEditor = ({ isOpen, onClose, onSave, initialData }: FlashcardEditorProps) => {
  const [displayMode, setDisplayMode] = useState<'stack' | 'grid'>(
    initialData?.displayMode || 'stack'
  );
  ...
  const updateCard = (index: number, field: keyof FlashcardContent, value: string) => {
  ...
  const triggerImageUpload = (cardIndex: number, side: 'front' | 'back') => {
  ...
  const handleImageUpload = (cardIndex: number, side: 'front' | 'back', event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="border-b pb-4">
            ...
            <RadioGroup value={displayMode} onValueChange={(value: 'stack' | 'grid') => setDisplayMode(value)}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: 'text' | 'image') => updateCard(index, 'frontType', value)}
                    >
                      <SelectTrigger>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      value={card.backType}
                      onValueChange={(value: 'text' | 'image') => updateCard(index, 'backType', value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select content type" />
                      </SelectTrigger>
