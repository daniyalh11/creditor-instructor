...
interface KnowledgeCheckEditorProps {
  open: boolean;
...
export const KnowledgeCheckEditor = ({ 
  open, 
  onOpenChange, 
  content,
  onSave 
}: KnowledgeCheckEditorProps) => {
  ...
  const [trueFalseAnswer, setTrueFalseAnswer] = useState(content?.correctAnswer || true);
        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              <RadioGroup value={trueFalseAnswer.toString()} onValueChange={(value) => setTrueFalseAnswer(value === 'true')}>
