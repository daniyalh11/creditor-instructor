...
const AddRuleDialog = ({ open, onOpenChange, type }: AddRuleDialogProps) => {
  ...
  const handleSave = () => {
    toast({
      title: `${type === 'start' ? 'Start' : 'Finish'} rule added`,
      description: `${type === 'start' ? 'Start' : 'Finish'} action rule has been successfully created`,
      duration: 3000,
    });
    onOpenChange(false);
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Add {type === 'start' ? 'Start' : 'Finish'} Rule</DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-2 items-end">
            ...
            <div className="space-y-2">
              <Label>Unit</Label>
              <Select value={formData.timeUnit} onValueChange={(value) => setFormData({ ...formData, timeUnit: value })}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.actionType} onValueChange={(value) => setFormData({ ...formData, actionType: value })}>
              ...
              <SelectContent>
                ...
                <SelectItem value="enrollment">Manage Enrollment</SelectItem>
              </SelectContent>
            </Select>
          </div>
            ...
            <>
              <div className="space-y-2">
                ...
                <Select value={formData.recipient} onValueChange={(value) => setFormData({ ...formData, recipient: value })}>
                  ...
                  <SelectContent>
                    <SelectItem value="learners">All Learners</SelectItem>
