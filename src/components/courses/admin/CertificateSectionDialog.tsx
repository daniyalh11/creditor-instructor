...
interface CertificateSectionDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const CertificateSectionDialog = ({ open, onOpenChange }: CertificateSectionDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        ...
        <DialogFooter className="gap-2">
          ...
          <Button onClick={handleSave} disabled={!sectionTitle || !selectedCertificate}>
            Add Section
          </Button>
        </DialogFooter>
      </DialogContent>
