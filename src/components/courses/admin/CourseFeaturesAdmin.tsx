...
import { GripVertical, Settings, Users, BookOpen, MessageSquare, Calendar } from "lucide-react";
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <h4 className="font-medium text-sm mb-2">Content Library</h4>
              <p className="text-xs text-gray-600 mb-3">Manage course resources and materials</p>
            ...
            <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <p className="text-xs text-gray-600 mb-3">Monitor learner progress and completion</p>
              <Button variant="outline" size="sm" className="w-full">
                Configure
              </Button>
            </div>
            ...
            <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <p className="text-xs text-gray-600 mb-3">Issue completion certificates</p>
              <Button variant="outline" size="sm" className="w-full">
                Configure
              </Button>
            </div>
            ...
            <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <h4 className="font-medium text-sm mb-2">Gamification</h4>
              <p className="text-xs text-gray-600 mb-3">Add badges and points system</p>
              <Button variant="outline" size="sm" className="w-full">
                Configure
              </Button>
            </div>
            ...
            <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <p className="text-xs text-gray-600 mb-3">Connect with external tools</p>
              <Button variant="outline" size="sm" className="w-full">
                Configure
              </Button>
            </div>
            ...
            <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
              <h4 className="font-medium text-sm mb-2">Advanced Analytics</h4>
              <p className="text-xs text-gray-600 mb-3">Detailed learning analytics</p>
              <Button variant="outline" size="sm" className="w-full">
                Configure
              </Button>
            </div>
