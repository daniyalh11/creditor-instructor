...
const CoursePathAdmin = () => {
  ...
  const pathSteps = [
    {
      ...
      icon: (
        <div className="flex space-x-2">
          <div className="w-8 h-10 bg-green-400 rounded"></div>
          <div className="w-8 h-10 bg-blue-400 rounded"></div>
          <div className="w-6 h-8 bg-yellow-400 rounded-t-full"></div>
        </div>
      )
    },
    {
      ...
      icon: (
        <div className="flex space-x-2">
          <div className="w-8 h-10 bg-blue-400 rounded relative">
            <div className="absolute top-1 left-1 w-2 h-2 bg-green-400 rounded"></div>
          </div>
          <div className="w-6 h-8 bg-yellow-400 rounded-t-full"></div>
        </div>
      )
    ...
    },
    {
      ...
      icon: (
        <div className="flex flex-col items-center">
          ...
          <div className="w-16 h-2 bg-blue-300 rounded-b"></div>
    ...
    return (
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Button 
            onClick={handleEnablePathFeatures}
  ...
  // Enhanced UI after enabling path features
  return (
    <div className="space-y-6">
      ...
      <CourseSectionDialog 
        open={courseSectionDialogOpen} 
        onOpenChange={setCourseSectionDialogOpen}
      />
      
      <CertificateSectionDialog 
        open={certificateSectionDialogOpen} 
        onOpenChange={setCertificateSectionDialogOpen}
      />
