...
const CourseAssessmentsAdmin = () => {
  ...
  const handleGradingChange = (key: string, value: string | boolean) => {
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('showAssessmentList', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('allowRetakes', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('randomizeQuestions', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('showCorrectAnswers', checked as boolean)
                      }
                    />
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('timeLimits', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('proctoringEnabled', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('autoGrading', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleFeatureChange('manualGrading', checked as boolean)
                      }
                    />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('notifyInstructorsOnSubmission', checked as boolean)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('notifyLearnersOnGrading', checked as boolean)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('reminderEmails', checked as boolean)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('deadlineAlerts', checked as boolean)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleNotificationChange('completionNotifications', checked as boolean)
                    }
                  />
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleGradingChange('weightedGrading', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleGradingChange('rubricEnabled', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleGradingChange('anonymousGrading', checked as boolean)
                      }
                    />
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleSettingsChange('lockdownBrowser', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleSettingsChange('questionBanking', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleSettingsChange('plagiarismCheck', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-3">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => 
                        handleSettingsChange('accessibilityOptions', checked as boolean)
                      }
                    />
