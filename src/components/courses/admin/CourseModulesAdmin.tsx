...
const CourseModulesAdmin = () => {
  ...
  const handleCurrentModuleChange = (key: string, value: boolean) => {
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleCurrentModuleChange('onlyShowUpToCurrent', checked as boolean)
                    }
                  />
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleCurrentModuleChange('hideIfNoCurrentLesson', checked as boolean)
                    }
                  />
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleCurrentModuleChange('autoSetCurrentByDate', checked as boolean)
                    }
                  />
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleLayoutChange('moduleDescriptions', checked as boolean)
                    }
                  />
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleLayoutChange('autoNumberModules', checked as boolean)
                    }
                  />
                ...
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleLayoutChange('quickNavigation', checked as boolean)
                    }
                  />
