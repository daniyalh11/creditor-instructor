...
interface AddEnrollmentActionDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  type: 'enrollment' | 'unenrollment' | 'reenrollment';
}

const AddEnrollmentActionDialog = ({ open, onOpenChange, type }: AddEnrollmentActionDialogProps) => {
