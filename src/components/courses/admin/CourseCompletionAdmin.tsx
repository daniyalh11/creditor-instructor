...
const CourseCompletionAdmin = () => {
  ...
  const handleCompletionSettingChange = (key: string, value: boolean) => {
  ...
  const handleSequencingChange = (key: string, value: boolean) => {
  ...
  const handleAutoCompletionChange = (key: string, value: boolean) => {
