...
interface SelectCertificateDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const SelectCertificateDialog = ({ open, onOpenChange }: SelectCertificateDialogProps) => {
            ...
            <div className="border rounded-lg p-4">
              <div className="flex items-start gap-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setSelectedCertificate(checked as boolean)}
                  className="mt-1"
                />
