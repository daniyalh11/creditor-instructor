...
interface AddCourseTimeDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const AddCourseTimeDialog = ({ open, onOpenChange }: AddCourseTimeDialogProps) => {
      ...
      <DialogContent className="sm:max-w-lg" hideCloseButton>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            ...
            {/* Day and time selectors in a flowing layout like the reference */}
