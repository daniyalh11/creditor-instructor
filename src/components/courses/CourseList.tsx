...
const CourseList = ({ courses, onCourseClick, onCourseEdit, onCourseDelete, onCourseArchive, courseType = 'open' }: CourseListProps) => {
  ...
  const handleRowClick = (courseId: string, title: string) => {
