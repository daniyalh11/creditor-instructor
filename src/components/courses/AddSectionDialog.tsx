...
const contentSections: SectionOption[] = [
  {
    id: 'page',
    title: 'Page',
...
const assessmentSections: SectionOption[] = [
  {
    id: 'quiz',
    title: 'Quiz',
...
const otherSections: SectionOption[] = [
  {
    id: 'checkbox',
    title: 'Checkbox',
...
const AddSectionDialog = ({ open, onOpenChange }: AddSectionDialogProps) => {
  const [activeTab, setActiveTab] = useState('content');
  const [specificDialogOpen, setSpecificDialogOpen] = useState<string | null>(null);

  const handleSectionClick = (section: SectionOption, category: string) => {
    // Close the main dialog first
    onOpenChange(false);
    
    // Open the specific dialog for the section type
  ...
  const renderSectionGrid = (sections: SectionOption[], category: string) => (
