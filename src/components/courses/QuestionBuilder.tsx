...
interface QuestionBuilderProps {
  ...
  onSave: (questions: Question[], timeLimitMinutes: number) => void;
  onPublish?: (questions: Question[], timeLimitMinutes: number) => void;
  onCancel: () => void;
...
const QuestionBuilder: React.FC<QuestionBuilderProps> = ({ 
  ...
  const [timeLimitMinutes, setTimeLimitMinutes] = useState<number>(initialTimeLimit);
