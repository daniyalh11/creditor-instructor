...
const CourseAdmin = () => {
  ...
  // Define all tabs with professional styling
  const allTabs = [
  ...
  // State to manage which tabs are visible and which are in "More"
  ...
  // Course metadata for the sidebar
  ...
  const handleMoreOptionClick = (selectedTabValue: string) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Fixed responsive layout that ensures admin panel stays on right */}
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-6 space-y-6 animate-fade-in">
          ...
          {/* Professional Tabs with better spacing */}
            ...
            <Card className="border-slate-200">
              <CardContent className="p-4">
                <TabsList className="grid w-full grid-cols-8 bg-slate-100 gap-2 p-2 h-auto">
                  ...
                  {/* More dropdown with better spacing */}
                  <DropdownMenu>
        ...
        {/* Fixed Admin Panel - Always on the right, scrollable */}
