...
const CourseCreationForm = () => {
  ...
  const [selectedBloomsTaxonomy, setSelectedBloomsTaxonomy] = React.useState<string[]>([]);
  ...
  const handleBloomsTaxonomyToggle = (level: string) => {
  ...
  const onSubmit = (data: CourseFormData) => {
    // Update the data with the selected categories, learning objectives, and Bloom's taxonomy
    ...
    // Redirect to the course builder with template info
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md animate-fade-in">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          {/* Categories/Tags - Enhanced with custom category creation */}
          <div className="space-y-4">
