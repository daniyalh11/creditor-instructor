...
const AssessmentReportDetail = ({ reportId, onBack }: ReportDetailProps) => {
  const [selectedColumns, setSelectedColumns] = useState<string[]>(['course_name']);

  // Mock data for the selected report
  const reportData = {
    id: reportId,
