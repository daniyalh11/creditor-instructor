...
interface AddResourceModalProps {
  ...
  onAddResource: (resource: { title: string; type: 'file' | 'link'; content: string; description?: string }) => void;
}

export const AddResourceModal = ({ open, onOpenChange, onAddResource }: AddResourceModalProps) => {
