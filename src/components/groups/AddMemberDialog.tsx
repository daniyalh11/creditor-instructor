...
interface AddMemberDialogProps {
  ...
  onAddMember: (memberData: { name: string; email: string; role: 'learner' | 'instructor' | 'admin' }) => void;
}
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={role} onValueChange={(value: 'learner' | 'instructor' | 'admin') => setRole(value)}>
              <SelectTrigger>
