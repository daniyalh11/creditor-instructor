...
export const RichTextEditor = React.forwardRef<
  HTMLDivElement,
  RichTextEditorProps
>(({ value, onChange, placeholder = "Add description for your event...", disabled = false, className }, ref) => {
  ...
  const handleLinkSave = useCallback((url: string, text: string, title?: string, target?: string) => {
    // Create a link element with the specified attributes
