    ...
    <section>
      <Card className="overflow-hidden border-blue-100 shadow-md hover:shadow-lg transition-all duration-300">
        <CardHeader className="bg-gradient-to-r from-blue-50 to-white flex flex-row items-center justify-between pb-2">
          ...
          <Badge variant="default" className="bg-blue-500 text-white rounded-full px-3 py-1 text-sm shadow-sm hover:bg-blue-600 transition-colors">Teaching&nbsp;{teachingCourses.length}</Badge>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {teachingCourses.map((course) => (
              ...
              >
                ...
                <h4 className="font-semibold text-base mb-2 text-blue-900 group-hover:text-blue-700 transition-colors">{course.title}</h4>
