...
const SurveyInstructorPage = () => {
  const { moduleId, surveyId } = useParams<{ moduleId: string; surveyId: string }>();
  const navigate = useNavigate();
  const [survey, setSurvey] = useState(sampleSurveyData[surveyId as keyof typeof sampleSurveyData] || sampleSurveyData['survey-1']);
