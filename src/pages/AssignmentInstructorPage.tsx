...
const AssignmentInstructorPage = () => {
  ...
  useEffect(() => {
    ...
    const foundAssignment = savedAssignments.find((a: Assignment) => a.id === assignmentId);
    
    if (foundAssignment) {
      setAssignment(foundAssignment);
    } else {
      // Sample assignment if not found
      const sampleAssignment: Assignment = {
        id: assignmentId || '',
        name: 'Assignment 1',
        topic: 'Financial Statement Analysis',
        description: 'Analyze various financial statements and provide insights on company performance, including balance sheets, income statements, and cash flow analysis.',
        instructions: [
