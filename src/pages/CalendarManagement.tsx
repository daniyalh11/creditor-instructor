...
interface Event {
  ...
  time: string;
  date: string;
  type: 'lecture' | 'workshop' | 'meeting' | 'deadline' | 'office-hours';
  location: string;
  attendees: string;
  course?: string;
  zoomUrl?: string;
...
const CalendarManagement = () => {
  ...
  const [newEvent, setNewEvent] = useState({
    ...
    type: 'lecture' as 'lecture' | 'meeting' | 'deadline',
    location: '',
    attendees: '',
    course: '',
    zoomUrl: ''
  ...
  const handleJoinZoom = (zoomUrl: string, eventTitle: string) => {
  ...
  const shouldShowZoomJoin = (event: Event) => {
          ...
          <DialogContent className="w-full max-w-md max-h-[85vh] overflow-hidden">
            ...
            <div className="overflow-y-auto max-h-[calc(85vh-120px)] pr-2">
              <div className="space-y-4">
                ...
                <Select value={newEvent.type} onValueChange={(value: 'lecture' | 'meeting' | 'deadline') => setNewEvent({ ...newEvent, type: value })}>
                  <SelectTrigger>
          ...
          {editingEvent && (
            <div className="overflow-y-auto max-h-[calc(85vh-120px)] pr-2">
              <div className="space-y-4">
                ...
                <Select value={editingEvent.type} onValueChange={(value: any) => setEditingEvent({ ...editingEvent, type: value })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
