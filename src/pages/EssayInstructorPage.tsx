...
const EssayInstructorPage = () => {
  const { moduleId, essayId } = useParams<{ moduleId: string; essayId: string }>();
  const navigate = useNavigate();
  const [essay, setEssay] = useState(sampleEssayData[essayId as keyof typeof sampleEssayData] || sampleEssayData['essay-1']);
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div>
                    ...
                    <p className="text-purple-700 font-medium mb-4 italic">Topic: {essay.topic}</p>
