...
const Profile = () => {
  ...
  const handleAvatarSave = (avatarSource: string) => {
    ...
    // Update avatar globally with enhanced storage and event dispatching
    ...
    // Force a custom update event for the header component
    setTimeout(() => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto p-4 sm:p-6">
      {/* Header Section with Instructor Badge */}
