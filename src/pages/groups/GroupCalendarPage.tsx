...
// Updated type definition to include all used modal modes
type ModalMode = 'create' | 'edit' | 'delete' | 'view' | 'event-list';
...
const GroupCalendarPage = () => {
  ...
  // Event form state (removed postToNewsFeed and rsvpEnabled)
  ...
  // Reset form to default values (removed postToNewsFeed and rsvpEnabled)
  ...
  // Load event data into form for editing (removed postToNewsFeed and rsvpEnabled)
