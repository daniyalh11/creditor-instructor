...
const Reports = () => {
  ...
  const filteredAssessmentReports = assessmentReports.filter(report =>
          ...
          <div className="mb-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="bg-transparent border-b w-full flex justify-start rounded-none gap-1 h-auto p-0">
                <TabsTrigger 
                  value="catalog" 
                  className="rounded-full py-2 px-6 data-[state=active]:bg-blue-500 data-[state=active]:text-white"
                >
                  Catalog
                </TabsTrigger>
                <TabsTrigger 
                  ...
                  {!selectedCategory ? (
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {selectedCategory === 'assessments' && filteredAssessmentReports.map((report) => (
                          <div 
                            key={report.id} 
