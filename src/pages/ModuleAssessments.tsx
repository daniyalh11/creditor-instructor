...
const ModuleAssessments = () => {
  ...
  // Get assignment count for the badge
  const getAssignmentCount = () => {
    const savedAssignments = JSON.parse(localStorage.getItem('assignments') || '[]');
    const moduleAssignments = savedAssignments.filter((a: any) => a.id.includes(moduleId)) || [];
    return moduleAssignments.length > 0 ? moduleAssignments.length : 3; // Default to 3 for sample data
  };
  ...
  const assessmentSections = [
    ...
    },
    {
      ...
      iconBg: 'bg-green-100',
      items: [] // Will be handled by AssignmentListing component
    },
    {
      id: 'essay',
      title: 'Essay Section',
